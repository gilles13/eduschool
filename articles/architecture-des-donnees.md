...
Pour les consultations simples, `eduschool` travaille directement à
partir des CSV. DuckDB est disponible pour effectuer des requêtes et des
jointures relationnelles plus libres, mais il n’est pas nécessaire au
fonctionnement de l’interface métier courante.
