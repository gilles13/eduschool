...
Les examens constituent une troisième chaîne de production, distincte
des fiches d’exercices et des fiches de révision. Pour le DNB, le flux
est :
...
banque. Ils sont décrits comme des ressources structurées puis dessinés
par R au moment du rendu. La vignette **Composer et produire un DNB de
mathématiques** détaille ce fonctionnement et la façon d’enrichir la
banque avec les nouvelles sessions.
