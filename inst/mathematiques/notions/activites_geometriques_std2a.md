...
Repères, méthodes et automatismes essentiels sur : Activités géométriques (uniquement pour la série STD2A).

## À connaître

Cette fiche rassemble les définitions, propriétés et repères indispensables pour travailler la notion **Activités géométriques (uniquement pour la série STD2A)**.
