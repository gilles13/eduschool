...
Repères, méthodes et automatismes essentiels sur : Fonction inverse.

## À connaître

Cette fiche rassemble les définitions, propriétés et repères indispensables pour travailler la notion **Fonction inverse**.
