...
Repères, méthodes et automatismes essentiels sur : Variables aléatoires.

## À connaître

Cette fiche rassemble les définitions, propriétés et repères indispensables pour travailler la notion **Variables aléatoires**.
