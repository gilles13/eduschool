...
generer_exercice = function(modele_id, niveau_id, capacite_id = NA_character_, difficulte = 1, seed = NULL) {
  f = switch(modele_id,
...
generer_lot_exercices = function(modele_id, niveau_id, n = 10, capacite_id = NA_character_, difficulte = 1, seed = 1) {
