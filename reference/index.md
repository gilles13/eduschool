...
- [`diagrammes_disponibles()`](https://gilles13.github.io/eduschool/reference/diagrammes_disponibles.md)
...
- [`parcoursup_etapes()`](https://gilles13.github.io/eduschool/reference/parcoursup_etapes.md)
  : Etapes de Parcoursup
- [`parcoursup_nouveautes()`](https://gilles13.github.io/eduschool/reference/parcoursup_nouveautes.md)
  : Nouveautes d'une campagne Parcoursup
- [`plateformes_admission()`](https://gilles13.github.io/eduschool/reference/plateformes_admission.md)
  : Plateformes nationales d'admission post-bac
- [`prerequis_capacite()`](https://gilles13.github.io/eduschool/reference/prerequis_capacite.md)
...
- [`produire_schema_parcoursup_svg()`](https://gilles13.github.io/eduschool/reference/produire_schema_parcoursup_svg.md)
